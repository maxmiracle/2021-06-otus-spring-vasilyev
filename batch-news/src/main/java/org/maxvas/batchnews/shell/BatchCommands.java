...
public class BatchCommands {
    ...
    public void startImportArticles() throws Exception {
        JobExecution execution = jobLauncher.run(importTheGuardianArticlesJob, new JobParametersBuilder()
                .addString(START_DATE_PARAM, appProps.getStartDate())
                .addString(END_DATE_PARAM, appProps.getEndDate())
                .toJobParameters());
    ...
    public void startMigrationJobWithJobOperator() throws Exception {
        Long executionId = jobOperator.start(IMPORT_THE_GUARDIAN_ARTICLES_JOB,
                START_DATE_PARAM + "=" + appProps.getStartDate() + "\n" +
